...
namespace TrackmaniaWebsiteAPI.MapInfo
{
    ...
    public class MapController(
        ...
        ApiTokensServiceRefactor apiTokensService2,
    ...
    ) : ControllerBase
    {
        ...
        // {
        //     string coreAccessToken = await apiTokensService2.RetrieveAccessTokenAsync(
        //         TokenTypesNew.Core
        //     );
        //
        //     var requestUri =
        ...
        //     }
        //     var otherRecords = await mapRecordsService.GetMapPersonalBestInfo(mapId, accountIdList);
        ...
        // {
        //     var liveAccessToken = await apiTokensService2.RetrieveAccessTokenAsync(
        //         TokenTypesNew.Live
        //     );
        //
        //     var requestUri =
